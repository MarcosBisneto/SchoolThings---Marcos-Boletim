...
import com.app.boletim.Modelos.Agendamento_;
...
public class AgendamentosActivity extends AppCompatActivity {
    ...
    private void removerTodos() {
        ...
        builder.setTitle("Boletim")
                .setMessage("Remover todos os agendamentos da lista?")
                .setPositiveButton("SIM", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Snackbar.make(recyclerAgendamentos, "Agendamentos foram removidos!", Snackbar.LENGTH_LONG).show();
                    }
                })
