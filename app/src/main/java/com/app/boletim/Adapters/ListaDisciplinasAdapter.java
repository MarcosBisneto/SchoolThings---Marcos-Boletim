...
import com.app.boletim.Modelos.Disciplina;
                ...
                if(item.getItemId() == R.id.adicionar_notas) {
                    if(tamanhoDaListaDeNotas == totalDeProvas) {
                        ...
                        if(this.disciplinas.get(position).getDisciplinaExtra()) {
                            Snackbar.make(view, "Não sera possivel adicionar nota em disciplinas extras.", Snackbar.LENGTH_LONG).show();
                        }
                    ...
                    if(tamanhoDaListaDeNotas < totalDeProvas) {
                        if(this.disciplinas.get(position).getDisciplinaExtra()) {
                            Snackbar.make(view, "Não e adicionar em disciplinas extras!", Snackbar.LENGTH_LONG).show();
                        }

                        else {
                            Snackbar.make(view, "E necessario ter 4 notas antes de cadastrar uma nota final.", Snackbar.LENGTH_LONG).show();
                        }
                    }

                    else {
                        if(disciplina.getMedia() >= mediaInstitucional) {
                            Snackbar.make(view, "Não precisa de Prova Final.", Snackbar.LENGTH_LONG).show();
                        }
