...
public class Disciplina {
    ...
    public String informarSituacao() {
        ...
        if(estaDeProvaFinal()) {
            ...
            if(getMedia() >= mediaInstitucional && getMedia() > mediaPessoal) {
                return "Aprovado e está acima da sua média pessoal.";
            }

            else if(getMedia() >= mediaInstitucional && getMedia() == mediaPessoal) {
                return "Aprovado pela prova final e atingiu sua média pessoal.";
            }

            else if(getMedia() >= mediaInstitucional && getMedia() < mediaPessoal) {
                return "Você foi aprovado, mas ainda está abaixo da sua média pessoal.";
            }
        }
